...
toList (Cursor left currentElement right) =
    List.reverse left ++ (currentElement :: right)
...
forward (Cursor left currentElement right) =
    case right of
        ...
        next :: rest ->
            Just (Cursor (currentElement :: left) next rest)
...
back (Cursor left currentElement right) =
    case left of
        ...
        prev :: rest ->
            Just (Cursor rest prev (currentElement :: right))
